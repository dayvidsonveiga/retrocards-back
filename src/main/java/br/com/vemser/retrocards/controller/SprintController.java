...
public class SprintController implements SprintDocumentation {
    ...
    @PostMapping("/create")
    public ResponseEntity<SprintDTO> create(@RequestBody @Valid SprintCreateDTO sprintCreateDTO) throws NegotiationRulesException {
    ...
    public ResponseEntity<Void> delete(@PathVariable("idSprint") Integer idSprint) throws NegotiationRulesException {
    ...
    public ResponseEntity<SprintCheckDTO> checkProgressRetrospectiveAndKudobox(@PathVariable("idSprint") Integer idSprint) throws NegotiationRulesException {
