...
public class EmailService {
    ...
    public void sendEmailFinishedRetrospective(UserDTO userDTO, String type) {
        ...
        try {
            ...
            mimeMessageHelper.setText(getContentFromTemplateRetrospective(userDTO, type), true);
    ...
    public String getContentFromTemplateRetrospective(UserDTO userDTO, String type) throws IOException,TemplateException {
